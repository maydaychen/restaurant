...
//    2——全部菜标识
	...
	public static final String IP = "10.0.2.2";//10.0.2.2
	public static final String PORT = "8080";
	
	//public static final String SERVER = "http://" + IP + ":" + PORT + "/food";
	public static final String SERVER = "http://" + IP + ":" + PORT + "/b_140327_food_server";
