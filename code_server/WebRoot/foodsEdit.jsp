		...
		<div class="loglist">
				<table width="90%" cellspacing="0" cellpadding="0" align="center">
					...
					<tr>
						...
						<td  width="70%">
							<input type="text" name="price" value="${map.food_price}">
						</td>
					</tr>
					<tr>
						<td  width="20%">
						...
						<td  width="70%">
							<input type="text" name="discountPrice" value="${map.food_discount_price}">
						</td>
					</tr>
					<tr>
						<td  width="20%">
				       ...
				       <c:forEach var="item" items="${typeList}"> 
				 			<option value="${item.name}" 	<c:if test="${(not empty map.flag) && (map.flag == item.name )}" > selected="selected" </c:if> >${item.name} </option>
				 		</c:forEach>	
				 			</select>
					...
					<tr>
						...
						<td  width="70%">
							<textarea name="description" rows="8" cols="40">${map.description}</textarea>
						</td>
					</tr>	
